...
### Round Log — `council-log/{{TOPIC_SLUG}}/round-{n}.md`

```markdown
[Round log template]
```

### On Consensus — `council-log/{{TOPIC_SLUG}}/decision.md`

```markdown
[Decision document template]
```

### On Early Termination — `council-log/{{TOPIC_SLUG}}/[termination-type].md`
